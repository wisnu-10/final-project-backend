...
export const JWT_ACCOUNT_ACTIOVATION_SECRET_KEY =
  process.env.JWT_ACCOUNT_ACTIOVATION_SECRET_KEY;
...
export const JWT_UPDATE_EMAIL_SECRET_KEY =
  process.env.JWT_UPDATE_EMAIL_SECRET_KEY;
